...
if _missing:
    st.error(
        ...
        "(berisi aug02.jpg, aug07.jpg, aug09.jpg, aug12.jpg, aug17.jpg) sudah di-commit ke repository "
...
# ---------------------------------------------------------------------------
    ...
    st.title("Timeline Perkembangan Kebakaran — 5 Titik Waktu")
    cols = st.columns(5)
    stats = {
    ...
    st.markdown(
        ...
        "untuk wisatawan mulai **Kamis, 20 Agustus 2026**."
    )
...
# PAGE 4 — Analitik & Prediksi
    ...
    st.info(
        ...
        "Modul prediksi di bawah ini tetap ditampilkan sebagai **arsip/analitik historis** "
        "atas dinamika rambatan api selama episode 3–17 Agustus 2026, bukan proyeksi "
