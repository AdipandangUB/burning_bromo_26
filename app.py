...
if _missing:
    st.error(
        ...
        "(berisi aug02.jpg, aug07.jpg, aug09.jpg, aug12.jpg, aug17.jpg, aug22.jpg) sudah di-commit ke repository "
...
if page == "Before–After Slider":
    ...
    pair = st.selectbox(
        ...
        [
            "2 Agustus → 22 Agustus (Awal vs Terbaru/Pemulihan)",
    ...
    mapping = {
        "2 Agustus → 22 Agustus (Awal vs Terbaru/Pemulihan)": ("2026-08-02", "2026-08-22"),
...
# ---------------------------------------------------------------------------
    ...
    st.title("Timeline Perkembangan Kebakaran — 6 Titik Waktu")
    cols = st.columns(6)
    stats = {
    ...
    st.markdown(
        ...
        "terbaru per **Sabtu, 22 Agustus 2026** tidak menunjukkan asap maupun "
        "titik panas aktif, menguatkan status padam dan mengindikasikan awal "
...
# PAGE 4 — Analitik & Prediksi
    ...
    st.info(
        ...
        "Citra Sentinel-2 terbaru **22 Agustus 2026** (ditampilkan sebagai overlay peta "
        "di bawah) tidak menunjukkan asap maupun titik panas aktif baru, menguatkan "
