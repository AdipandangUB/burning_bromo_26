"""
WebGIS Interaktif — Monitoring Kebakaran TNBTS (Agustus–September 2026)
...
IMAGES = {
    ...
    "2026-08-29": {"file": os.path.join(IMG_DIR, "aug29.jpg"), "label": "29 Agustus 2026 (Pemulihan stabil)"},
    ...
    "2026-09-11": {"file": os.path.join(IMG_DIR, "sep11.jpg"), "label": "11 September 2026 (Terbaru)"},
}
...
if page == "Before–After Slider":
    ...
    pair = st.selectbox(
        ...
        [
            "2 Agustus → 11 September (Awal vs Terbaru/Pemulihan)",
            "29 Agustus → 11 September (Pemulihan stabil vs Terbaru)",
            "1 September → 11 September (Update vs Terbaru)",
            "6 September → 11 September (Konsistensi pemulihan)",
            "17 Agustus → 11 September (Padam vs Terbaru)",
    ...
    mapping = {
        "2 Agustus → 11 September (Awal vs Terbaru/Pemulihan)": ("2026-08-02", "2026-09-11"),
        "29 Agustus → 11 September (Pemulihan stabil vs Terbaru)": ("2026-08-29", "2026-09-11"),
        "1 September → 11 September (Update vs Terbaru)": ("2026-09-01", "2026-09-11"),
        "6 September → 11 September (Konsistensi pemulihan)": ("2026-09-06", "2026-09-11"),
        "17 Agustus → 11 September (Padam vs Terbaru)": ("2026-08-17", "2026-09-11"),
...
- **29 Agustus** — kondisi padam yang stabil, tanpa indikasi aktivitas kebakaran baru. Burn scar dan pola pemulihan vegetasi tampak konsisten dengan citra 27 Agustus, menguatkan tren pemulihan bertahap pasca-kebakaran di kawasan kaldera.
...
- **11 September** — citra terbaru masih menunjukkan kondisi padam yang stabil, dengan tren regenerasi vegetasi yang terus berlanjut pada flank kaldera. Area kawah tengah (lautan pasir) tetap tampak seperti kondisi alaminya.
        """
    )
...
# ---------------------------------------------------------------------------
    ...
    stats = {
        ...
        "2026-08-29": "Pemulihan stabil — kondisi padam konsisten",
        ...
        "2026-09-11": "Terbaru — tren regenerasi vegetasi berlanjut, kondisi padam stabil",
    }
    keys = list(IMAGES.keys())
    n_cols = 4
    for row_start in range(0, len(keys), n_cols):
        row_keys = keys[row_start:row_start + n_cols]
    ...
    st.markdown(
        ...
        "**Sabtu, 29 Agustus 2026**, **Selasa, 1 September 2026**, **Minggu, "
        "6 September 2026**, dan **Jumat, 11 September 2026** (citra terbaru) "
        "secara konsisten tidak menunjukkan asap maupun titik panas aktif, "
        "menguatkan status padam dan mengindikasikan tren pemulihan vegetasi "
        "yang terus berlanjut pada area terdampak."
    )
...
# PAGE 4 — Analitik & Prediksi
    ...
    st.info(
        ...
        "Citra Sentinel-2 terbaru **11 September 2026** (ditampilkan sebagai overlay peta "
        "di bawah) tidak menunjukkan asap maupun titik panas aktif baru, konsisten "
        "dengan seluruh citra sejak 22 Agustus hingga 6 September 2026, menguatkan "
        "status padam. Modul prediksi di bawah ini tetap ditampilkan sebagai "
