...
# untuk episode 3–17 Agustus; baris setelah 17 Agustus TIDAK berasal dari
# rilis resmi BPBD/TNBTS (belum ada laporan luasan baru dipublikasikan),
# melainkan interpretasi visual citra Sentinel-2 pada aplikasi ini sendiri
# — ditandai pasti=False dan wajib diverifikasi ke sumber resmi.
# ---------------------------------------------------------------------------
AREA_DATA = pd.DataFrame([
    ...
    {"tanggal": "2026-08-22", "luas_ha": 1121.66, "catatan": "Kondisi padam berlanjut pada citra Sentinel-2; belum ada laporan luasan baru dari BPBD/TNBTS", "pasti": False},
    {"tanggal": "2026-08-27", "luas_ha": 1121.66, "catatan": "Kondisi padam berlanjut pada citra Sentinel-2; belum ada laporan luasan baru dari BPBD/TNBTS", "pasti": False},
    {"tanggal": "2026-08-29", "luas_ha": 1121.66, "catatan": "Kondisi padam berlanjut pada citra Sentinel-2; belum ada laporan luasan baru dari BPBD/TNBTS", "pasti": False},
...
# ---------------------------------------------------------------------------
    ...
    st.markdown(
        ...
        "per **Sabtu, 22 Agustus 2026**, **Kamis, 27 Agustus 2026**, **Sabtu, "
        "29 Agustus 2026**, **Selasa, 1 September 2026**, dan **Minggu, "
        "6 September 2026** secara konsisten tidak menunjukkan asap maupun titik "
        "panas aktif, menguatkan status padam dan mengindikasikan tren pemulihan "
        "vegetasi yang terus berlanjut pada area terdampak. Namun citra Sentinel-2 "
        "terbaru **Jumat, 11 September 2026** menunjukkan **titik api dan kepulan "
